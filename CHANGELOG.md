...
- d02646b: Nested lists exported to Markdown now keep their hierarchy when the file is read back by other Markdown tools.
- d02646b: Fix a denial-of-service risk where crafted block or inline Markdown attributes could consume excessive CPU and block the browser or server event loop.
- d02646b: Prevent untrusted HTML attributes from changing an object's prototype when merged with `mergeAttributes`.
...
- d02646b: Pasting a YouTube iframe without a `src` attribute no longer crashes the editor. The embed is kept without a source.
- Updated dependencies [d02646b]
- Updated dependencies [d02646b]
- Updated dependencies [d02646b]
  - @tiptap/core@4.0.0-next.0
...
- d02646b: StarterKit no longer installs the deprecated `@tiptap/extension-dropcursor`, `@tiptap/extension-gapcursor`, `@tiptap/extension-list-item`, and `@tiptap/extension-list-keymap` packages. We will not publish further updates to these packages. StarterKit still includes their extensions, so you do not need to change your configuration.
...
- d02646b: Fix Markdown serialization of whitespace-only marked text.
- Updated dependencies [d02646b]
- Updated dependencies [d02646b]
- Updated dependencies [d02646b]
  - @tiptap/core@4.0.0-next.0
...
- d02646b: Vue 2 support is removed. `@tiptap/vue-3` is now `@tiptap/vue`, and `@tiptap/extension-drag-handle-vue-3` is now `@tiptap/extension-drag-handle-vue`.
